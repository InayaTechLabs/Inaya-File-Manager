<?php
/**
 * Plugin Name:       Inaya File Manager
 ...
 * Text Domain:       inaya-file-manager
 * Domain Path:       /languages
 * Update URI:        https://github.com/InayaTechLabs/WP-Files
 *
...
function wpfm_load_textdomain() {
	load_plugin_textdomain( 'inaya-file-manager', false, dirname( WPFM_PLUGIN_BASENAME ) . '/languages' );
}
